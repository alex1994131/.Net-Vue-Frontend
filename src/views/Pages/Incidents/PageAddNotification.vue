                          ...
                          <v-card class="ma-0">
                            <v-simple-table dense>
                              <template v-slot:default>
                                <thead>
                                  <tr>
                                    <th class="text-right">الآيبي مصدر</th>
                                    <th class="text-right">المنفذ مصدر</th>
                                    <th class="text-right">الدولة مصدر</th>
                                    <th class="text-right">الآيبي هدف</th>
                                    <th class="text-right">المنفذ هدف</th>
                                    <th class="text-right">الدولة هدف</th>
                                ...
                                <tbody>
                                  <tr
                                    v-for="ip in incident.IpAddresses"
                                    :key="ip.id"
                                  >
                                    <td>{{ ip.source.ip }}</td>
                                    <td>
                                    ...
                                    <td>{{ ip.dest.port }}</td>
                                    <td>
                                      {{ ip.destinationCountry }}
                                    </td>
                                    <td>
                                      {{ (ip.beginTimestamp.toUTCString()) }}
                                    </td>
                                    <td>
                                      {{ (ip.endTimestamp.toUTCString()) }}
                                    </td>
                                  </tr>
                                </tbody>
                              </template>
...
export default {
  ...
  computed: {
    ...mapGetters("incidents", ["getUrgancy", "getSver", "getCat", "getfile"]),
    getOperations() {
  ...
  methods: {
    ...
    ...mapActions("incidents", ["addIncident", "fetchData", "addCategories"]),
    tagsHandler(tags) {
      console.log(tags);
